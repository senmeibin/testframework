...
import com.bpms.cmn.dao.FaqDao;
 ...
 */
@Service
public class FaqService extends CmnBaseService<FaqExt> {
    @Autowired
     ...
     */
    @Override
    protected void validateBefore(FaqExt entity) {
     ...
     */
    @Override
    protected void validateAfter(FaqExt entity) {
     ...
     */
    @Override
    protected FaqExt saveBefore(FaqExt entity) {
        return entity;
    }
     ...
     */
    @Override
    protected FaqExt saveAfter(FaqExt entity) {
        return entity;
    }
     ...
     */
    @Override
    protected Boolean deleteBefore(FaqExt entity) {
        return true;
    }
     ...
     */
    @Override
    protected Boolean deleteAfter(FaqExt entity) {
        return true;
    }
