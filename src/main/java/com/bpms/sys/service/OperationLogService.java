 ...
 */
@Service
public class OperationLogService extends SysBaseService<OperationLogExt> {
    @Autowired
     ...
     */
    @Override
    protected void validateBefore(OperationLogExt entity) {
     ...
     */
    @Override
    protected void validateAfter(OperationLogExt entity) {
     ...
     */
    @Override
    protected OperationLogExt saveBefore(OperationLogExt entity) {
        return entity;
    }
     ...
     */
    @Override
    protected OperationLogExt saveAfter(OperationLogExt entity) {
        return entity;
    }
     ...
     */
    @Override
    protected Boolean deleteBefore(OperationLogExt entity) {
        return true;
    }
     ...
     */
    @Override
    protected Boolean deleteAfter(OperationLogExt entity) {
        return true;
    }
