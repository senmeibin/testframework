...
import com.bpms.sys.dao.CityManageDao;
 ...
 */
@Service
public class CityManageService extends SysBaseService<CityManageExt> {
    @Autowired
    private CityManageDao cityManageDao;

    @Override
    public CityManageDao getDao() {
     ...
     */
    @Override
    protected void validateBefore(CityManageExt entity) {
     ...
     */
    @Override
    protected void validateAfter(CityManageExt entity) {
     ...
     */
    @Override
    protected CityManageExt saveBefore(CityManageExt entity) {
        return entity;
    }
     ...
     */
    @Override
    protected CityManageExt saveAfter(CityManageExt entity) {
        return entity;
    }
     ...
     */
    @Override
    protected Boolean deleteBefore(CityManageExt entity) {
        return true;
    }
     ...
     */
    @Override
    protected Boolean deleteAfter(CityManageExt entity) {
        return true;
    }
