 ...
 */
@Service
public class SmsLogService extends SysBaseService<SmsLogExt> {
    @Autowired
    private SmsLogDao smsLogDao;

    @Override
    public SmsLogDao getDao() {
        return smsLogDao;
    }
     ...
     */
    @Override
    protected void validateBefore(SmsLogExt entity) {
     ...
     */
    @Override
    protected void validateAfter(SmsLogExt entity) {
     ...
     */
    @Override
    protected SmsLogExt saveBefore(SmsLogExt entity) {
        return entity;
    }
     ...
     */
    @Override
    protected SmsLogExt saveAfter(SmsLogExt entity) {
        return entity;
    }
     ...
     */
    @Override
    protected Boolean deleteBefore(SmsLogExt entity) {
        return true;
    }
     ...
     */
    @Override
    protected Boolean deleteAfter(SmsLogExt entity) {
        return true;
    }
