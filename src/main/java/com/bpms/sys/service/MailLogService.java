 ...
 */
@Service
public class MailLogService extends SysBaseService<MailLogExt> {
    @Autowired
    private MailLogDao mailLogDao;

    @Override
    public MailLogDao getDao() {
        return mailLogDao;
    }
     ...
     */
    @Override
    protected void validateBefore(MailLogExt entity) {
     ...
     */
    @Override
    protected void validateAfter(MailLogExt entity) {
     ...
     */
    @Override
    protected MailLogExt saveBefore(MailLogExt entity) {
        return entity;
    }
     ...
     */
    @Override
    protected MailLogExt saveAfter(MailLogExt entity) {
        return entity;
    }
     ...
     */
    @Override
    protected Boolean deleteBefore(MailLogExt entity) {
        return true;
    }
     ...
     */
    @Override
    protected Boolean deleteAfter(MailLogExt entity) {
        return true;
    }
