 ...
 */
@MappedSuperclass
public class SmsLogHistory extends SysBaseEntity {
    private static final long serialVersionUID = -20180313080632999L;
     ...
     * 发送结果
     */
    @Range(min = 0L, max = 99999999L, message = "请在发送结果中输入[0-99999999]范围内的数值。")
