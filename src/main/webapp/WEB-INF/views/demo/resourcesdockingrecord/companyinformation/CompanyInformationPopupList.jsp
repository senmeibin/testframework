...
<script type="text/javascript" src="${staticContentsServer}/static/js/demo/resourcesdockingrecord/companyinformation/CompanyInformationPopupList.js?${version}"></script>
...
<script type="text/javascript">
    ...
    function CompanyInformationPopupList_Page_Load() {
        ...
        instance.resourcesDockingRecordInputUrl = "${ctx}/demo/resourcesdockingrecord/input";
