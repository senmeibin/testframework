...
<script type="text/javascript" src="${staticContentsServer}/static/js/demo/companyinvestment/CompanyInvestmentInnerInput.js?${version}"></script>


<div class="panel-body CompanyInvestmentInnerInput-MainContent" id="companyInvestmentInnerInputDiv" style="display: none;padding-top:0px;">
    <div style="border: 1px solid #09c; border-top-width: 3px; padding: 15px 0;">
        ...
        <div class="text-center margin-top-space">
            <button type="button" class="btn btn-primary btn-100px" id="btnSave"><i class="fa fa-save"></i>保存投融资</button>
...
<script type="text/javascript" language="javascript">
    //<![CDATA[
    function CompanyInvestmentInnerInput_Page_Load() {
        SysApp.Demo.CompanyInvestmentInnerInputIns = new SysApp.Demo.CompanyInvestmentInnerInput();
        var instance = SysApp.Demo.CompanyInvestmentInnerInputIns;
        instance.selfInstance = "SysApp.Demo.CompanyInvestmentInnerInputIns";
        instance.controller = "${ctx}/demo/companyinvestment/";
        instance.clientID = "CompanyInvestmentInnerInput";

        instance.init();
    }

    CompanyInvestmentInnerInput_Page_Load();
    //]]>
</script>