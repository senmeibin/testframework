...
<script type="text/javascript" src="${staticContentsServer}/static/js/demo/companypersonnel/CompanyPersonnelInput.js?${version}"></script>

<title>人员结构编辑</title>
<%--注：为区分页面对象包含的数据范围，需要在MainContent前加上画面前缀--%>
<div class="wrapper">
    <div class="panel content-min-height">
        <div class="panel-heading CompanyPersonnelInput-MainContent">
            <em></em>
            <div class="panel-title" id="ctlTitle">人员结构编辑</div>
        ...
        <div class="panel-body">
            ...
            <div class="CompanyPersonnelInput-MainContent margin-top-space">
...
<script type="text/javascript" language="javascript">
    //<![CDATA[
    function CompanyPersonnelInput_Page_Load() {
        SysApp.Demo.CompanyPersonnelInputIns = new SysApp.Demo.CompanyPersonnelInput();
        var instance = SysApp.Demo.CompanyPersonnelInputIns;
        instance.selfInstance = "SysApp.Demo.CompanyPersonnelInputIns";
        instance.controller = "${ctx}/demo/companypersonnel/";
        instance.listUrl = "${ctx}/demo/companypersonnel/list";
        instance.clientID = "CompanyPersonnelInput";

        instance.init();
    }

    CompanyPersonnelInput_Page_Load();
    //]]>
</script>
<%--操作说明--%>
<ctag:HelpPopup pageInstance="SysApp.Demo.CompanyPersonnelInputIns"/>