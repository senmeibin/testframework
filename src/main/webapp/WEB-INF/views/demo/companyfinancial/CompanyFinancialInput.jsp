...
<script type="text/javascript" src="${staticContentsServer}/static/js/demo/companyfinancial/CompanyFinancialInput.js?${version}"></script>

<title>财务信息编辑</title>
<%--注：为区分页面对象包含的数据范围，需要在MainContent前加上画面前缀--%>
<div class="wrapper">
    <div class="panel content-min-height">
        <div class="panel-heading CompanyFinancialInput-MainContent">
            <em></em>
            <div class="panel-title" id="ctlTitle">财务信息编辑</div>
        ...
        <div class="panel-body">
            ...
            <div class="CompanyFinancialInput-MainContent margin-top-space">
...
<script type="text/javascript" language="javascript">
    //<![CDATA[
    function CompanyFinancialInput_Page_Load() {
        SysApp.Demo.CompanyFinancialInputIns = new SysApp.Demo.CompanyFinancialInput();
        var instance = SysApp.Demo.CompanyFinancialInputIns;
        instance.selfInstance = "SysApp.Demo.CompanyFinancialInputIns";
        instance.controller = "${ctx}/demo/companyfinancial/";
        instance.listUrl = "${ctx}/demo/companyfinancial/list";
        instance.clientID = "CompanyFinancialInput";

        instance.init();
    }

    CompanyFinancialInput_Page_Load();
    //]]>
</script>
<%--操作说明--%>
<ctag:HelpPopup pageInstance="SysApp.Demo.CompanyFinancialInputIns"/>