...
<script type="text/javascript" src="${staticContentsServer}/static/js/demo/companycopyright/CompanyCopyrightInput.js?${version}"></script>

<title>专利版权编辑</title>
<%--注：为区分页面对象包含的数据范围，需要在MainContent前加上画面前缀--%>
<div class="wrapper">
    <div class="panel content-min-height">
        <div class="panel-heading CompanyCopyrightInput-MainContent">
            <em></em>
            <div class="panel-title" id="ctlTitle">专利版权编辑</div>
        ...
        <div class="panel-body">
            ...
            <div class="CompanyCopyrightInput-MainContent margin-top-space">
                ...
                <form id="MainForm" class="form-horizontal">
                    ...
                    <div id="divBaseInfo" class="separate-block clearfix">
                        <div class="form-group form-inline">
                            ...
                            <div class="col-lg-3">
                                <input id="provincialLevelNum" type="text" class="form-control" data-title="当前获得省级以上奖励(万元)" maxlength="13" data-rangelength="[0,13]" data-range="[0,99999999]" data-number="true" style="width: 220px;" data-money="true"/>
...
<script type="text/javascript" language="javascript">
    //<![CDATA[
    function CompanyCopyrightInput_Page_Load() {
        SysApp.Demo.CompanyCopyrightInputIns = new SysApp.Demo.CompanyCopyrightInput();
        var instance = SysApp.Demo.CompanyCopyrightInputIns;
        instance.selfInstance = "SysApp.Demo.CompanyCopyrightInputIns";
        instance.controller = "${ctx}/demo/companycopyright/";
        instance.listUrl = "${ctx}/demo/companycopyright/list";
        instance.clientID = "CompanyCopyrightInput";

        instance.init();
    }

    CompanyCopyrightInput_Page_Load();
    //]]>
</script>
<%--操作说明--%>
<ctag:HelpPopup pageInstance="SysApp.Demo.CompanyCopyrightInputIns"/>