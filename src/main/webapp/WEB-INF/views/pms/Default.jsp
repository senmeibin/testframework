...
<script type="text/javascript" src="${staticContentsServer}/static/js/pms/Default.js?${version}"></script>
<title>系统首页</title>
...
<script type="text/javascript" language="javascript">
    ...
    function Default_Page_Load() {
        SysApp.Pms.DefaultIns = new SysApp.Pms.Default();
        var instance = SysApp.Pms.DefaultIns;
        instance.selfInstance = "SysApp.Pms.DefaultIns";
        instance.controller = "${ctx}/pms/default/";
