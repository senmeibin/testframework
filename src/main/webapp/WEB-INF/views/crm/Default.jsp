...
<script type="text/javascript" src="${staticContentsServer}/static/js/crm/Default.js?${version}"></script>
<title>系统首页</title>
...
<script type="text/javascript" language="javascript">
    ...
    function Default_Page_Load() {
        SysApp.Crm.DefaultIns = new SysApp.Crm.Default();
        var instance = SysApp.Crm.DefaultIns;
        instance.selfInstance = "SysApp.Crm.DefaultIns";
        instance.controller = "${ctx}/crm/default/";
