SysApp.Portal.Common = function () {
}

//定义数据输入画面JS类
SysApp.Portal.CommonInput = Class.create();
SysApp.Portal.CommonInput.prototype = Object.extend(new SysCmn.CoreInput(), {
...
//定义数据导入画面JS类
SysApp.Portal.CommonImport = Class.create();
SysApp.Portal.CommonImport.prototype = Object.extend(new SysCmn.CoreImport(), {});

//定义数据一览画面JS类
SysApp.Portal.CommonList = Class.create();
SysApp.Portal.CommonList.prototype = Object.extend(new SysCmn.CoreList(), {
    //取得表结构的主键名称[注意：必须实现的方法]
    getPrimaryKey: function () {
        return "uid";
    },
