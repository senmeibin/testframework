SysApp.Crm.Common = function () {
}

//定义数据输入画面JS类
SysApp.Crm.CommonInput = Class.create();
SysApp.Crm.CommonInput.prototype = Object.extend(new SysCmn.CoreInput(), {
...
//定义数据导入画面JS类
SysApp.Crm.CommonImport = Class.create();
SysApp.Crm.CommonImport.prototype = Object.extend(new SysCmn.CoreImport(), {});

//定义数据一览画面JS类
SysApp.Crm.CommonList = Class.create();
SysApp.Crm.CommonList.prototype = Object.extend(new SysCmn.CoreList(), {
    //取得表结构的主键名称[注意：必须实现的方法]
    getPrimaryKey: function () {
        return "uid";
    },
