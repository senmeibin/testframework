//定义数据一览画面JS类
SysApp.Crm.ClassStudentPopupList = Class.create();

SysApp.Crm.ClassStudentPopupList.prototype = Object.extend(new SysApp.Crm.CommonList(), {
    //初期化回调处理
    ...
    initTableColList: function () {
        ...
        this.colList.push(new ColInfo("备注", "remark", "29%", SORT_YES, ALIGN_LEFT, false, CAMEL_NO));
