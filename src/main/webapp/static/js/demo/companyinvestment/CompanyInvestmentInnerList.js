//定义数据一览画面JS类
SysApp.Demo.CompanyInvestmentInnerList = Class.create();

SysApp.Demo.CompanyInvestmentInnerList.prototype = Object.extend(new SysApp.Demo.CompanyExtendedCommonList(), {
    //初期化回调处理
