//定义数据一览画面JS类
SysApp.Demo.CompanyIntellectualInnerList = Class.create();

SysApp.Demo.CompanyIntellectualInnerList.prototype = Object.extend(new SysApp.Demo.CompanyExtendedCommonList(), {
    //初期化回调处理
