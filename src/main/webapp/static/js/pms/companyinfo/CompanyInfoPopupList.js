//定义数据一览画面JS类
SysApp.Pms.CompanyInfoPopupList = Class.create();

SysApp.Pms.CompanyInfoPopupList.prototype = Object.extend(new SysApp.Pms.CommonList(), {
    //初期化回调处理
